...
4.) Are you up to the challenge of the said shift, learnig it and appyling it in your future career as math teacher. 
	- Yes, Im up to the challenge of the said shift, learning it and applying it in my future career as Math teacher because making a shareable documents in quarto is a living as claerly as possible in the time we have, we can share it with others and improve as we use it again. This new package will help me in teaching profession by sing the codes that Im learning today. And as a future Math teacher this new package will help me to do a documents using Quarto in R and I will teach it to my futre students so that they will also know what is the use of RStudio.
